 ...
 */
final class Version20241218191820 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, genre_id INT DEFAULT NULL, user_id INT DEFAULT NULL, date_r DATE NOT NULL, titre_r VARCHAR(255) NOT NULL, description_r LONGTEXT NOT NULL, status_r VARCHAR(255) NOT NULL, traitement VARCHAR(255) NOT NULL, INDEX IDX_CE6064044296D31F (genre_id), INDEX IDX_CE606404A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
