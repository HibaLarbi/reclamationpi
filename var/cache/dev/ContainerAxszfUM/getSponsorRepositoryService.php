 ...
 */
class getSponsorRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SponsorRepository' shared autowired service.
     *
     * @return \App\Repository\SponsorRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SponsorRepository.php';

        return $container->privates['App\\Repository\\SponsorRepository'] = new \App\Repository\SponsorRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
