 ...
 */
class getCommandeProduitRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommandeProduitRepository' shared autowired service.
     *
     * @return \App\Repository\CommandeProduitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommandeProduitRepository.php';

        return $container->privates['App\\Repository\\CommandeProduitRepository'] = new \App\Repository\CommandeProduitRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
