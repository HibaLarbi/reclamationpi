 ...
 */
class getCoachingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CoachingRepository' shared autowired service.
     *
     * @return \App\Repository\CoachingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CoachingRepository.php';

        return $container->privates['App\\Repository\\CoachingRepository'] = new \App\Repository\CoachingRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
